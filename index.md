...
seismoacoustic method;</li>
  ...
  <p><ins>The encoding of these attributes was implemented by a simple mapping of the known values as seen in line 'put line number showing numerical encoding', this encoding allowed for easier interpretability as we will see later.</ins></p>
 </ul>
</ul>
